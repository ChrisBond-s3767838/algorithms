...
public interface MyArray
{
     ...
     */
    public abstract void set(int index, int newValue) throws IndexOutOfBoundsException;
     ...
     * @throws IndexOutOfBoundsException In index are out of bounds.
     */
    public abstract void add(int newValue) throws IndexOutOfBoundsException;
     ...
     * @throws IndexOutOfBoundsException In index are out of bounds.
     */
    public abstract void insert(int index, int newValue) throws IndexOutOfBoundsException;
